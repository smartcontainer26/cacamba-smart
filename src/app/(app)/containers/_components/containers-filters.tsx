...
export function ContainersFilters() {
  ...
  const updateParam = (key: string, value: string) => {
    ...
    params.delete("page");
    // Limpa msg de sucesso ao filtrar
    params.delete("msg");
  ...
  return (
    <div className="mb-6 flex flex-wrap items-center gap-3">
      ...
      <input
        ...
        className="w-56 rounded-md border border-border bg-surface px-3 py-1.5 text-sm placeholder:text-text-muted focus:border-accent focus:outline-none focus:ring-2 focus:ring-accent/30"
      />
    </div>
  );
}
